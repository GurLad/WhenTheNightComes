...
public class Conductor : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Sync volume
        musicSource.volume = CrossfadeMusicPlayer.Instance.Volume;
    }
    ...
    public static void Pause()
    {
        ...
        //Record the time when the music was paused
        instance.dspPauseStart = (float)AudioSettings.dspTime;
    }
    ...
    public static void Resume()
    {
        ...
        instance.dspSongTime += (float)AudioSettings.dspTime - instance.dspPauseStart;
    }
